...
public class ReviewValidationMessages extends ValidationMessages {
    ...
    public static final String USER_ID_INVALID_MESSAGE = "ID пользователя должен быть положительным";
    public static final String FILM_ID_INVALID_MESSAGE = "ID фильма должен быть положительным";
