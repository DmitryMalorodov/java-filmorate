...
import ru.yandex.practicum.filmorate.dal.mappers.ReviewReactionRowMapper;
...
public class ReviewReactionRepository extends BaseRepository<ReviewReaction> {
    ...
    public ReviewReactionRepository(JdbcTemplate jdbc, ReviewReactionRowMapper mapper) {
        super(jdbc, mapper);
    }
