...
@DisplayName("Проверка получения отзыва")
public class GetReviewIdTest extends ReviewTest {

    @Autowired
    public GetReviewIdTest(ReviewRepository reviewRepository) {
    ...
    void checkGettingOneReview() throws Exception {
        ...
        mockMvc.perform(get(REVIEWS_ID, reviewId))
